...
class Test_Genom_Transaltor(unittest.TestCase):
    ...
    def test_extract_tree_expression(self):
        ...
        self.assertEqual(expression, 'sin(exp(1*_1_**1)+(1*_3_**1)*(1*_5_**1)^(cos(1*_2_**1)-((1*_4_**1)+0)/(1*_6_**1)+0)+0)+')
...
def create_dna_dict():
    ...
    pre_order_correct = [(3,1,1,0,1,1,0,1,3), (1,3,0,2,1,1,0,0,0), (2,5,0,4,1,1,0,0,0), (5,2,1,1,1,1,0,2,0), (4,4,1,3,1,1,0,0,0), (6,6,0,0,1,1,0,0,0)]
